...
<!-- CONTENT -->
<center>
<h2>MultiCrop results</h2>

<table class="intro">
<tr><td class="subheader">Polygon:</td><td class="Abbr"><xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Rowset/tjs:Row/tjs:K" /></td></tr>
...
<xsl:for-each select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Rowset/tjs:Row/tjs:V">
<tr>
<td class="Abbr"><xsl:value-of select="@aid" /></td>
<td class="Abbr"><xsl:value-of select="." /></td>
<td class="Abbr"><xsl:element name="a"><xsl:attribute name="href">/lsrs/service?ClimateTable=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:ClimateTableName"/>&amp;CmpTable=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:CmpTable"/>&amp;POLYID=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Rowset/tjs:Row/tjs:K" />&amp;CROP=<xsl:value-of select="@aid" />&amp;RESPONSE=Summary</xsl:attribute>Summary</xsl:element></td>
<td class="Abbr"><xsl:element name="a"><xsl:attribute name="href">/lsrs/service?ClimateTable=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:ClimateTableName"/>&amp;CmpTable=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:CmpTable"/>&amp;POLYID=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Rowset/tjs:Row/tjs:K" />&amp;CROP=<xsl:value-of select="@aid" />&amp;RESPONSE=Details</xsl:attribute>Details</xsl:element></td>
</tr>
</xsl:for-each>
</table>
