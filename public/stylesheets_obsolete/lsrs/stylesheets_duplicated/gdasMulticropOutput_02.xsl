...
<td class="Abbr"><xsl:element name="a"><xsl:attribute name="href">/lsrs/service?ClimateTable=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:ClimateTableName"/>&amp;FrameworkName=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:FrameworkName"/>&amp;POLYID=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Rowset/tjs:Row/tjs:K" />&amp;CROP=<xsl:value-of select="@aid" />&amp;RESPONSE=Summary</xsl:attribute>Summary</xsl:element></td>
<td class="Abbr"><xsl:element name="a"><xsl:attribute name="href">/lsrs/service?ClimateTable=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:ClimateTableName"/>&amp;FrameworkName=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:FrameworkName"/>&amp;POLYID=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Rowset/tjs:Row/tjs:K" />&amp;CROP=<xsl:value-of select="@aid" />&amp;RESPONSE=Details</xsl:attribute>Details</xsl:element></td>
</tr>
</xsl:for-each>
</table>
