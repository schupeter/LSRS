...
<tr><td class="subheader">Climate:</td><td class="Abbr"><xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Attribute/tjs:ClimateTable" /></td></tr>
<tr><td class="subheader">Crop:</td><td class="Abbr"><xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Attribute/tjs:AttributeName" /></td></tr>
</table>
<br/>
...
<td class="Abbr"><xsl:element name="a"><xsl:attribute name="href">/lsrs/service?ClimateTable=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Attribute/tjs:ClimateTable"/>&amp;CmpTable=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Attribute/tjs:CmpTable"/>&amp;POLYID=<xsl:value-of select="tjs:K" />&amp;CROP=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Attribute/tjs:AttributeName" />&amp;RESPONSE=Summary</xsl:attribute>Summary</xsl:element></td>
<td class="Abbr"><xsl:element name="a"><xsl:attribute name="href">/lsrs/service?ClimateTable=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Attribute/tjs:ClimateTable"/>&amp;CmpTable=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Attribute/tjs:CmpTable"/>&amp;POLYID=<xsl:value-of select="tjs:K" />&amp;CROP=<xsl:value-of select="//tjs:GDAS/tjs:Framework/tjs:Dataset/tjs:Attribute/tjs:AttributeName" />&amp;RESPONSE=Details</xsl:attribute>Details</xsl:element></td>
</tr>
</xsl:for-each>
</table>
