...
{:value=>480, :deduction=>80, :rating=>["supports a single cut of alfalfa with no allowance for carryover to subsequent seasons","Class 5-6 boundary"]},
{:value=>930, :deduction=>70, :rating=>["minimum GDD for one cut of alfalfa per year","Class 4-5 boundary"]},
{:value=>1410, :deduction=>55, :rating=>["minimum GDD for two cuts of alfalfa per year","Class 3-4 boundary"]},
{:value=>1890, :deduction=>20, :rating=>["minimum GDD for three cuts of alfalfa per year","Class 1-2 boundary"]},
{:value=>2150, :deduction=>0}
]

GSL_DEDUCTIONS = [
{:value=>0, :deduction=>100},
{:value=>65, :deduction=>80, :rating=>["supports a single cut, with no carryover","Class 5-6 boundary"]},
{:value=>120, :deduction=>70, :rating=>["supports a single cut, with carryover","Class 4-5 boundary"]},
{:value=>165, :deduction=>55, :rating=>["supports two cuts per year","Class 3-4 boundary"]},
{:value=>210, :deduction=>20, :rating=>["supports three cuts per year","Class 1-2 boundary"]},
{:value=>230, :deduction=>0}
]
